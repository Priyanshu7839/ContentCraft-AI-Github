...
const CreateWithAISidebar = () => {

    const Create_sidebar_items = ['Start Creating'];

  return (
    <div className='h-[85vh] w-[300px] bg-[#1e2d4a] px-[1rem] py-[2rem] flex flex-col gap-[3rem] rounded-r-[10px] items-center'>

    <h1 className='text-center font-semibold font-Inter text-[28px] text-[#ffffff]'>Create With AI</h1>
...
export default CreateWithAISidebar
