    ...
    {/* -------------------------------------------heading and back button--------------------------------- */}
        <div className='p-[4rem] pt-0 flex flex-col gap-[3rem] font-Inter text-[#ffffff]'>
            ...
            >
                ...
                <h1 className='font-semibold text-[26px]'>Incident Reporting Form</h1>
            ...
            <div className='p-[2rem] bg-[#374868] flex flex-col gap-[2rem]  rounded-[10px] font-Inter'>
                ...
                <div className='flex flex-col gap-[.5rem]'>
                        <h1 className='font-Inter font-medium text-[18px]'>Descibe the Incident</h1>
                ...
                <div className='flex items-center gap-[2rem]'>
                    ...
                    <div className='w-[50%] flex flex-col gap-[.5rem] font-Inter'>
                        ...
                        <h2 className='text-justify font-normal text-[12px]'>If you've encountered an incident or issue, please fill out the form below to report it. Our incident response team will investigate and take appropriate action.</h2>
                    </div>
                </div>
                {/* ----------------------------------------------- */}
                {/* ------------------Submit Button----------------------------- */}
