...
const AccountAssistanceForm = () => {
    const dispatch = useDispatch();
    return (
        <div className='min-h-[100vh]'>

            {/* -------------------------------------------- Account Assistance Form field--------------------------------- */}
            <div className='p-[4rem] pt-0 flex flex-col gap-[3rem] font-Inter text-[#ffffff]'>
                ...
                >
                    ...
                    <h1 className='font-semibold text-[26px]'>Account Assistance Support Form</h1>
                ...
                <div className='p-[2rem] bg-[#374868] flex flex-col gap-[3rem] rounded-[10px]'>
                    ...
                    <div className='flex flex-col gap-[1rem]'>
                        <h1 className='font-semibold text-[20px] text-[#ff7643]'>Need help with your account?</h1>
                        <p className='font-normal text-[16px]'>Fill out the form below to request assistance. Our support team will review your request and provide the necessary help to resolve your account-related issues.</p>
                    </div>
                    {/* ------------------------Name input------------------------------------- */}
                    ...
                    <div className='flex flex-col gap-[.5rem]'>
                        <h1 className='font-Inter font-medium text-[18px]'>Describe the Issues</h1>
...
export default AccountAssistanceForm
