...
const ContentGenerationSupportForm = () => {
    const dispatch = useDispatch();
  return (
    <div className='min-h-[100vh]'>

    {/* --------------------------------------------Content Generation Support Form field--------------------------------- */}
    <div className='p-[4rem] pt-0 flex flex-col gap-[3rem] font-Inter text-[#ffffff]'>
        ...
        >
            ...
            <h1 className='font-semibold text-[26px]'>Content Generation Issues Support Form</h1>
        ...
        <div className='p-[2rem] bg-[#374868] flex flex-col gap-[3rem] rounded-[10px]'>
            ...
            <div className='flex flex-col gap-[1rem]'>
                <h1 className='font-semibold text-[20px] text-[#ff7643]'>Encountering challenges with content generation?</h1>
                <p className='font-normal text-[16px]'>Fill out the form below to request support. Our team will assist you in resolving issues and optimizing your content creation experience.</p>
            </div>
            {/* ------------------------Name input------------------------------------- */}
            <div className='flex items-center gap-[2rem]'>
                ...
                <div className='flex flex-col gap-[.5rem]'>
                        <h1 className='font-Inter font-medium text-[18px]'>Describe the Content Generation Issues</h1>
                        <textarea name="" id="" rows="10" placeholder='Describe The Issues...' className='w-[100%] text-[#000] p-[.5rem] rounded-[10px] border-none outline-none'></textarea>
...
export default ContentGenerationSupportForm
